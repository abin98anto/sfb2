...
var GetCategoriesUseCase = /** @class */ (function () {
    function GetCategoriesUseCase(categoryRepository) {
        var _this = this;
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            skip = (page - 1) * limit;
                            return [4 /*yield*/, this.categoryRepository.getCount(search)];
                        case 1:
                            totalCount = _d.sent();
                            return [4 /*yield*/, this.categoryRepository.getPaginated({
                                    skip: skip,
                                    limit: limit,
                                    search: search,
                                })];
                        ...
                        case 3:
                            ...
                            return [2 /*return*/, { success: false, message: comments_1.comments.CAT_FETCH_FAIL, err: error_1 }];
