...
var GetAllSubscriptionsUseCase = /** @class */ (function () {
    function GetAllSubscriptionsUseCase(subscriptionRepository) {
        var _this = this;
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            skip = (page - 1) * limit;
                            return [4 /*yield*/, this.subscriptionRepository.getCount(search)];
                        case 1:
                            totalCount = _d.sent();
                            return [4 /*yield*/, this.subscriptionRepository.getPaginated({
                                    skip: skip,
                                    limit: limit,
                                    search: search,
                                })];
                        ...
                        case 3:
                            error_1 = _d.sent();
                            console.log(comments_1.comments.SUB_ALL_FETCH_UC_FAIL, error_1);
                            return [2 /*return*/, {
                                    success: false,
                                    message: comments_1.comments.SUB_ALL_FETCH_UC_FAIL,
                                    err: error_1,
                                }];
...
exports.default = GetAllSubscriptionsUseCase;
