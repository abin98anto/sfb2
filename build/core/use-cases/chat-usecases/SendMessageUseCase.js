...
var SendMessageUseCase = /** @class */ (function () {
    function SendMessageUseCase(messageRepository) {
        var _this = this;
        ...
        this.execute = function (message) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        console.log(comments_1.comments.MESSAGE_CREATE_UC_FAIL, error_1);
                        return [2 /*return*/, {
                                success: false,
                                message: comments_1.comments.MESSAGE_CREATE_UC_FAIL,
                                err: error_1,
                            }];
