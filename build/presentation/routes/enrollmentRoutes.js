...
enrollmentRoutes.get("/user-enrollments", authMiddleware, enrollmentController.getUserCourses);
...
enrollmentRoutes.post("/get-enroll-details", enrollmentController.getEnrollments);
