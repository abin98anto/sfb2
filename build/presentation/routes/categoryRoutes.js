...
categoryRouter.put("/update", authMiddleware, authorize, categoryController.update);
categoryRouter.delete("/delete", authMiddleware, authorize, categoryController.softDelete);
