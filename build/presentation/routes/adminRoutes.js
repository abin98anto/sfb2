...
var AddMoneyToWalletUseCase_1 = __importDefault(require("../../core/use-cases/admin-usecases/AddMoneyToWalletUseCase"));
...
var addMoneyToWalletUseCase = new AddMoneyToWalletUseCase_1.default(userRepository);
var adminController = new AdminControllers_1.AdminController(getUsersUseCase, blockUserUseCase, approveTutorUseCase, denyTutorUseCase, addMoneyToWalletUseCase);
