...
var RazorpayController = /** @class */ (function () {
    function RazorpayController() {
        var _this = this;
        this.createRazorpayOrder = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var _a, amount, currency, options, order, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        res.status(500).json({
                            success: false,
                            message: comments_1.comments.RZPAY_ERR,
                            error: error_1 instanceof Error ? error_1.message : comments_1.comments.UNKOWN_ERR,
                        });
                        return [3 /*break*/, 3];
